...
| Lista de temas — Gravitación, versión `(3)` (2 pág., recibida el 2026-09-17) | `C:\Users\frans\Downloads\Lista de temas Gravitación (3).pdf` | superconjunto de la `(2)`: oficializa **«Esfera de influencia — Curtis 8.4»** y **«Patched orbits — Curtis 8.5»**, que hasta ahí estaban en el apunte a pedido del destinatario y no de la cátedra. Cruzada entera contra los veinte módulos el 2026-09-17 — ver `TEMARIO.md` |
| Lista de temas — Impulso angular (2 pág., recibida el 2026-09-25) | `C:\Users\frans\Downloads\Lista de temas Impulso angular (1).pdf` | transcripta en `TEMARIO.md`, cruzada fila por fila contra el módulo `rotacion`. Es toda del **S&Z vol. 1, caps. 9–10** (offset: pág. impresa = pág. del PDF − 27) |
