...
| Pisacane, *The Space Environment and Its Effects on Space Systems* (AIAA, 2008) | `The Space Environment and Its Effects on Space Systems __ -- Pisacane, Vincent L_ -- ... -- An.pdf` — 441 páginas, 12 capítulos, con capa de texto (no hace falta rasterizar) | **Sin cerrar — ambigüedad real, no falta de tiempo.** El libro trae en el prefacio (PDF pág. 14-16) su propio programa de 37 clases para un cuatrimestre completo. El cruce contra `../../fisica-espacial/fuentes/TEMARIO.md` (pedido por Fran) dio cero coincidencias de vocabulario, lo que deja dos lecturas posibles de "correlativo" con resultados distintos — 6 capítulos (3,4,6,8,9,11) o 7 (3,4,5,6,8,9,11), según si el 5 (campo gravitatorio, que Pisacane cubre con más profundidad que el M6 del apunte: WGS84, mareas, precesión por J2) cuenta como continuación de lo confirmado. Detalle completo en `docs/bitacora.md`. Fran decide cuál lectura vale cuando arranque la fase 1. |
