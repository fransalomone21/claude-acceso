...
|---|---|---|
| [`arquitectura-se/`](proyectos/ingenieria/arquitectura-se/CLAUDE.md) | Reformar el método (cascada, PDP, naturalezas, frenos) contra NASA SP-2016-6105, INCOSE y Rechtin | **ACTIVO** — **fases 0-5 cerradas**: los cuatro libros leídos y medidos, y la arquitectura nueva diseñada con trade study explícito (B 810 / A 430 / C 400), en los tres documentos de `docs/`. **Fase 6 ABIERTA (migrar) — es la primera que TOCA ARCHIVOS VIVOS, con rigor pleno: saboteador antes de cada pieza.** Primer tramo cerrado el 17/09: **los tres defectos vivos arreglados** (D12 el conteo ahora se deriva; D14 el chequeo de requisitos deja de ser de idioma inglés, con la aceptación de tres mitades como control permanente; y el medidor de desuso, que hace cobrable el criterio C6). De paso, **tres BACKSPACE dentro de archivos vivos** —uno en el .md que se inyecta en cada sesión— y el chequeo de ASCII que miraba una sola punta del rango. Faltan las 5 piezas P1/P4/P5/P6/P7 y **un proyecto real migrado**, que es lo que cierra |
