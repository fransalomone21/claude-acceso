...
| [`fisica-espacial/`](proyectos/documentos/fisica-espacial/CLAUDE.md) | Apunte general de Física Espacial (UNSAM, Ing. en Sistemas Espaciales) en Typst, 173 pág. | **ACTIVO** — reabierto el 2026-09-25 por la lista de temas *Impulso angular*. **Fase 9 cerrada**: entró el módulo `rotacion` (Sears caps. 9–10, las 17 filas de la lista con sección) y el giróscopo de la guía (S&Z 10.51) resuelto a fondo; **21 módulos, 187 pág.** **Fase 10 abierta: Fran aprueba la voz** del módulo 17, tercera vuelta (sarcástica, integrada en la prosa, sin chistes anunciados); de paso 218 de las 407 cajas del apunte pasaron a marcas de color en el texto (**180 pág.**). El piloto **ya quedó publicado** en el Drive público —lo subió el hook `post-commit` sin que la sesión lo quisiera—; dejarlo o volver atrás lo decide Fran. Después, la pasada por los 20 módulos (`medir-estilo.py`: PENDIENTE 58) |
