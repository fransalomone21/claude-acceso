...
| [`apunte-iise/`](proyectos/documentos/apunte-iise/CLAUDE.md) | Apunte general de Introducción a la Ingeniería de Sistemas Espaciales (UNSAM), unidades 1 a 7, en Typst. Se rinde sobre distinciones léxicas, así que el **glosario controlado es el módulo 0** y hay un verificador de léxico | **ACTIVO** — **fases 0, 1 y 2 cerradas** (2026-09-20). Las **7 unidades escritas**: 28 módulos, 71 términos de glosario, PDF de **115 páginas**, `verificar-lexico.py` en verde. La unidad 6 salió con 5 módulos en vez de los 4 previstos. **Fase 3 abierta**: mapear las 16 preguntas de los parcialitos 1-3 contra los módulos, sin huérfanas. La fase 4 (publicar en Drive) queda a criterio de Fran |
