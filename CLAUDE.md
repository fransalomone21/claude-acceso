...
| [`apunte-iise/`](proyectos/documentos/apunte-iise/CLAUDE.md) | Apunte general de Introducción a la Ingeniería de Sistemas Espaciales (UNSAM), unidades 1 a 7, en Typst. Se rinde sobre distinciones léxicas, así que el **glosario controlado es el módulo 0** y hay un verificador de léxico | **ACTIVO** — **fases 0, 1, 2 y 3 cerradas** (2026-09-20). Las **7 unidades escritas**: 28 módulos, 71 términos de glosario, PDF de **115 páginas**, `verificar-lexico.py` en verde. La unidad 6 salió con 5 módulos en vez de los 4 previstos. La **fase 3 cerró** con las 16 preguntas de los parcialitos mapeadas y ninguna huérfana — y de paso encontró que el mapeo que ya estaba escrito **estaba mal en 9 de las 16**, porque se había hecho a nivel módulo y de memoria: ahora lo mide `verificar-cobertura.py`, que exige el **título exacto de la sección**. **Sólo queda la fase 4** (publicar en Drive), a criterio de Fran |
