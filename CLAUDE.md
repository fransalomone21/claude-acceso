...
| [`apunte-iise/`](proyectos/documentos/apunte-iise/CLAUDE.md) | Apunte general de Introducción a la Ingeniería de Sistemas Espaciales (UNSAM), unidades 1 a 7, en Typst. Se rinde sobre distinciones léxicas, así que el **glosario controlado es el módulo 0** y hay un verificador de léxico | **ACTIVO** — **fase 0 cerrada** (2026-09-20): las 590 diapositivas extraídas a `.txt`, 177 diapositivas-figura a PNG, y el material de NotebookLM medido — de sus 149 anclas, **4** apuntaban a la página real. Fase 1 abierta: el glosario |
