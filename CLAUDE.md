...
| [`apunte-iise/`](proyectos/documentos/apunte-iise/CLAUDE.md) | Apunte general de Introducción a la Ingeniería de Sistemas Espaciales (UNSAM), unidades 1 a 7, en Typst. Se rinde sobre distinciones léxicas, así que el **glosario controlado es el módulo 0** y hay un verificador de léxico | **ACTIVO** — **fases 0 y 1 cerradas** (2026-09-20). La 0 dejó las 590 diapositivas en `.txt` y midió las anclas de NotebookLM: de 149, **4** apuntaban a la página real. La 1 cerró con `verificar-lexico.py` en verde y su saboteador poniéndolo en rojo; encontró **cinco defectos reales** en su primera corrida. **Fase 2 abierta, con PDF: 100 páginas** — **6 de 7 unidades** (65 términos de glosario), incluida la unidad 6 (155 diapositivas, la más larga), que salió con **cinco** módulos en vez de los cuatro previstos. Queda sólo la unidad 7 |
